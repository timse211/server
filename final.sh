...
while :
    do
        ...
        2)
            ...
            echo -e "please watch out you have created index.html in your /var/www/html/$dirname"
            ...
            do
                read -p "Want to only set this user belong to this dir(/var/www/html/$dirname/)?(yes/no):" yn
            done
        ...
        4)
            ...
            echo -e "All settings, chroot_list file and service is restart";;
        5)
